                ...
                <div className="grid md:grid-cols-12 gap-12 items-center pt-32">
                    <div className="md:col-span-8 space-y-8">
                        <div className="space-y-2">
                            <h2 className="text-2xl text-gray-600 font-medium tracking-wide">
                                In the era of
                            </h2>
                        ...
                        <div className="pt-8">
                            <a href='#' className='
                                ...
                                bg-bermuda hover:bg-tahiti transition-all duration-300
                                py-3 px-8 text-white font-medium rounded-full
                    ...
                    <div className="md:col-span-4 relative group">
                        <div className="absolute inset-0 bg-gradient-to-r from-bermuda/20 
                            to-tahiti/20 rounded-xl transform rotate-2 group-hover:rotate-3 
